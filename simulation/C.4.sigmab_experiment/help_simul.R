...
###------------------- Set rood directory ----------------------###
root.dir = "/nas/longleaf/home/chanhwa/research/NPSACI/"
...
DGP <- function(N, type = "data", taus = NULL, thetas = NULL, r = NULL, sigma.b = 0.5){
...
data.sim = function(m, sigma.b){
  N.list = N.dist(m)
  data = lapply(N.list, DGP, sigma.b = sigma.b)
...
estimands.sim = function(M, taus, thetas, theta0, r, sigma.b = 0.5){
  N.list = N.dist(M)
  estimands = lapply(N.list, DGP, type = "estimands", taus = taus, thetas = thetas, r = r, sigma.b = sigma.b)
