...
## Read estimates over sigma.b values ##

data.plot = data.frame()

for(sigma.b in c(0,0.5,1,2)){
  
  print(paste0("sigma.b = ",sigma.b))
  
  estimate.list = list.files(paste0("estimate/m100_r100_nonpara_sigmab",sigma.b,"/Rdata"), 
...
ggsave(filename = "FigS3.sigmab.comparison.m100.D1000.pdf", width = 8, height = 4)
