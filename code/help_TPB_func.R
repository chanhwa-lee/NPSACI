...
w.over.H = function(a.i, X.i, N.i, thetas, H.fit, P.A_bar.thetas){
...
OutReg = function(A.i, X.i, N.i, taus, thetas, r = 0, F.fit, H.fit, P.A_bar.thetas){
  ...
  OR.over.H.i = function(a.i){
    ...
    w.over.H.i.a.i.thetas = w.over.H(a.i, X.i, N.i, thetas, H.fit, P.A_bar.thetas)
...
IF = function(Y.i, D.i, A.i, X.i, N.i, taus, thetas, r = 0, F.fit, G.fit, H.fit){
  ...
  w.over.H.i.thetas = w.over.H(A.i, X.i, N.i, thetas, H.fit, P.A_bar.thetas)
  ...
  OR.thetas.taus = OutReg(A.i, X.i, N.i, taus, thetas, rr, F.fit, H.fit, P.A_bar.thetas)
