...
w.over.H.TypeB = function(a.i, X.i, N.i, thetas, H.fit){
...
phi.over.H.TypeB = function(A.i, X.i, N.i, a.i, thetas, H.fit){
...
OutReg.TypeB = function(A.i, X.i, N.i, taus, thetas, r = 0, F.fit, H.fit){
  ...
  OR.over.H.i = function(a.i){
    ...
    w.over.H.i.a.i.thetas = w.over.H.TypeB(a.i, X.i, N.i, thetas, H.fit)
    phi.over.H.i.a.i.thetas = phi.over.H.TypeB(A.i, X.i, N.i, a.i, thetas, H.fit)
...
IF.TypeB = function(Y.i, D.i, A.i, X.i, N.i, taus, thetas, r = 0, F.fit, G.fit, H.fit){
  ...
  w.over.H.i.thetas = w.over.H.TypeB(A.i, X.i, N.i, thetas, H.fit)
